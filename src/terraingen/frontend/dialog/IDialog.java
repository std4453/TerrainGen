 ...
 * actions: Accepts an input, displays GUI, collects
 * user input, and returning the result.<br />
 ...
 * letting the user input a number or displaying a simple message while confirming the
